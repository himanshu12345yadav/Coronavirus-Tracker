                ...
                <form className="form-group needs-validation pb-5">
                    <div className="form-row d-flex justify-content-center align-items-center">
                        ...
                        <select
                            ...
                            ref={weeks_count}
                            style={{ padding: '0.5px' }}
                            className="form-control btn btn-outline-info text-nowrap align-self-start col-2 mx-2 col-md-2 col-lg-1"
